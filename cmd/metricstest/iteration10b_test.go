...
import (
	...
	"github.com/mipt-golang-course/go-autotests/internal/fork"
)
...
func (suite *Iteration10BSuite) SetupSuite() {
	...
	envs := append(os.Environ(), []string{
		...
		"RESTORE=true",
		"STORE_INTERVAL=10",
		"DATABASE_DSN='postgres://unknown:unknown@postgres:9999/mipt?easter_egg_msg=you_must_prefer_this_incorrect_settings_to_those_obtained_through_arguments'",
	}...)
